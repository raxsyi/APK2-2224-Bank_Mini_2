...
<head>
    ...
    <style>
        body {
            background-image: url(../img/tilt/2.jpg);
                                    ...
                                    <form class="form-login" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="hidden" id="inputName" name="id_user" class="form-control mb-4" value="<?php echo autonumber("tbl_users", "id_user", 3, "AMD") ?>" >
                                        ...
                                        <button type="submit" name="registrasi" class="btn_1 full_width text-center">Register</button>
                                        <p>Need an account?<a href="login.php">LOGIN</a></p>
...
<!-- Mirrored from demo.dashboardpack.com/cryptocurrency-html/resister.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Apr 2024 07:10:14 GMT -->
